...
class MicroenvTab(object):
    ...
    def __init__(self):
        ...
        self.oxygen_initial_condition = FloatText(value=0,style=style, layout=widget_layout)
        ...
        self.oxygen_Dirichlet_boundary_condition_value_xmax = FloatText(value=38,style=style, layout=widget2_layout)
        ...
        self.oxygen_Dirichlet_boundary_condition_value_ymin = FloatText(value=38,style=style, layout=widget2_layout)
        ...
        self.oxygen_Dirichlet_boundary_condition_value_ymax = FloatText(value=38,style=style, layout=widget2_layout)
        ...
        self.oxygen_Dirichlet_boundary_condition_value_zmax = FloatText(value=38,style=style, layout=widget2_layout)
